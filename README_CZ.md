...
Specifikace:
- Senzor: Sensirion STCC4
- Měřené veličiny: CO₂, teplota, relativní vlhkost
- Rozsah měření CO₂: 400 – 5000 ppm
- Přesnost měření CO₂: ±(30 ppm + 3 % hodnoty)
- Přesnost měření teploty: ±0,8 °C
- Přesnost měření vlhkosti: ±3 % RH
- Rozhraní: I²C (až 400 kHz)
- Napájecí napětí: 3,3 V
- Spotřeba: nízká, vhodné pro bateriové aplikace
- Rozměry modulu:  23 × 22 mm
